...
import com.saasforge.mcdonalds.kiosk.bean.QuarterPound;
 ...
 * @author Janis
 */
public class QuarterPoundMealBuilder implements MealBuilderInterface {

    private Meal meal = new Meal();

    public QuarterPoundMealBuilder() {
        this.meal.setSandwich(new QuarterPound());
    }
