...
import com.saasforge.mcdonalds.kiosk.bean.Hamburger;
 ...
 * @author Janis
 */
public class HamburgerMealBuilder implements MealBuilderInterface {

    private Meal meal = new Meal();

    public HamburgerMealBuilder() {
        this.meal.setSandwich(new Hamburger());
    }
    ...
    public MealBuilderInterface makeRegular() {
        ...
        this.meal.setFry(new FryRegular());
        this.meal.setComputePrice(2.95);
        return this;
    }
    ...
    public MealBuilderInterface makeMedium() {
        ...
        this.meal.setComputePrice(3.95);
        return this;
    }
